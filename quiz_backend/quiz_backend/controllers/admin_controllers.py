...
def set_questions(admin_question_input : QuizModel , session : Annotated[Session , Depends(get_session)]):
    ...
    choice01 = Choices(choice=admin_question_input.choice1, status=admin_question_input.choice1_status)
    choice02 = Choices(choice=admin_question_input.choice2, status=admin_question_input.choice2_status)
    choice03 = Choices(choice=admin_question_input.choice3, status=admin_question_input.choice3_status)
    
    question = Quiz(question=admin_question_input.question, quizLevel_id=admin_question_input.quiz_level_id, questions=[choice01, choice02, choice03] )
