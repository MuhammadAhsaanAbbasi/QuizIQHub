...
class QuizLevel(SQLModel, table=True):
    ...
    category_id: Optional[int]  = Field(int, foreign_key="category.category_id")  # Foreign key relationship to Category
...
class Quiz(SQLModel, table=True):
    ...
    quiz_level_id: Optional[int]  = Field(int, foreign_key="quizlevel.quiz_level_id")  # Foreign key relationship to QuizLevel
...
class Choices(SQLModel, table=True):
    ...
    quiz_id: Optional[int]  = Field(int, foreign_key="quiz.question_id")  # Foreign key relationship to Quiz
